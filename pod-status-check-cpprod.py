...
os.system("gcloud container clusters get-credentials cpprod --zone asia-east1-b --project static-grid-211306")

rockcube_pod_status_check="kubectl get pods"
Notification_URL='https://hooks.slack.com/services/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'
